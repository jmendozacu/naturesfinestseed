...
$username = 'naturesfinestsea';
$password = 'o4xWXZ0pBiPTTsRW8n';
...
function parseMagentoDbConfig() {
    ...
    foreach($connections as $connection) {
        if(intval($connection->active) == 1) {
            define('DB_SERVER', (string)$connection->host);
...
if ((get_magic_quotes_runtime() || get_magic_quotes_gpc()) && $g_iCartType != 9) {
