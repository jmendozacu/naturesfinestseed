...
class Ophirah_Qquoteadv_Model_Observer_Products_Massupdate
{
    ...
    {
        $postField = Ophirah_Qquoteadv_Helper_Massupdate::getMassPostTypes($type);
        Mage::helper('qquoteadv/massupdate')->update(
            $type,
            $products,
            $request->getParam($postField, false),
            $request->getParam('website_id', false)
        );
        return $this;
    }
    ...
    protected function getFormFieldsForExclusion(){
        return Ophirah_Qquoteadv_Helper_Massupdate::getMassUpdateTypes();
    }
