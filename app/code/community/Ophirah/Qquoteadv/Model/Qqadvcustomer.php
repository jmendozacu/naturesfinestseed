...
//    }
                ...
                if ($recalType == 1) { // Fixed
                    ...
                    if(Mage::helper('tax')->priceIncludesTax($this->getStoreId())){
                        ...
                        foreach ($requestItems as $item) {
                            ...
                            if($firstProduct->getTypeId() != 'bundle'){
                                break;
                            } else {
                    ...
                    $orgFinalBasePrice = $this->getData('orgFinalBasePrice');
    ...
    public function getQuoteReduction()
    {
        ...
        //orgFinalBasePrice is already calculated in the current currency
        $orgBasePrice = $this->getAddress()->getQuote()->getData('orgFinalBasePrice');
                ...
                foreach ($quoteItems as $quoteItem) {
                    ...
                    if (Mage::helper('tax')->priceIncludesTax($this->getStoreId())){
                        ...
                        if($percent > 0){
                            ...
                            $customPrice = ($calculationPrice / (100+$percent)) * 100;
                        }
                    }
    ...
    public function setShippingMethod(Ophirah_Qquoteadv_Model_Quoteshippingrate $rateData = null)
    {
        ...
        if(empty($rateData)) {
            ...
            if ($shippingType == "I" || $shippingType == "O") {
                ...
                $methodDescription = Mage::getStoreConfig("carriers/qquoteshiprate/title");
                $methodDescription .= " - ".Mage::getStoreConfig("carriers/qquoteshiprate/name");//TODO: Non store specific
