...
class Mango_Categorytabs_Model_Eav_Entity_Attribute_Group extends Mage_Eav_Model_Entity_Attribute_Group
{
    /**
    ...
    {
        $this->_init('categorytabs/eav_entity_attribute_group');
    }
