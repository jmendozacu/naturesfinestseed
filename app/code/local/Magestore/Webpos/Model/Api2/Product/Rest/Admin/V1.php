...
//            ->addAttributeToFilter('visibility', Mage_Catalog_Model_Product_Visibility::VISIBILITY_BOTH)
        ...
        foreach ($collection as $productModel) {
            ...
            /* START Rooney fix */
            if ($productModel->getTypeId() == Mage_Catalog_Model_Product_Type_Configurable::TYPE_CODE) {
                $childIds = Mage::getModel('catalog/product_type_configurable')->getChildrenIds($productModel->getId());
                $item['child_ids'] = empty($childIds)?array():array_keys($childIds[0]);
            }
            /* END Rooney fix */
